...
function Footer() {
  return (
    <>
      <div className="h-56 box-border bg-black text-white flex justify-center items-center relative">
        {/* top div */}
        <div className="w-full absolute top-0 h-0.5 bg-white"></div>

        {/* Left */}
        <div
          className="w-1/3 h-52  flex justify-center items-end flex-col gap-8 mr-8"
          id="left"
        >
          <h2 className={`text-3xl  ${majorMonoDisplay.className}`}>
            rAj rAndiVe
          </h2>
          <div className="flex flex-wrap w-full items-end justify-end">
            {links.map((eachlinks) => (
          ...
          {/* SOCIAL LINKS   */}
          <div
            className="bg-white text-black rounded-full w-auto pr-4 pl-4 pt-3 pb-3 flex gap-4"
            id="socialLinks"
          >
            <div>
              <svg
        ...
        {/* LINE */}
        <div className="w-0.5 h-44 bg-white" id="middle"></div>

        {/* Right */}
        <div
          className="w-1/3 h-52  flex flex-col justify-center items-start gap-6 ml-8"
          id="right"
        >
          {/* SOCIAL LINKS   */}
